 ...
 */
uint8_t setMode_apds(uint8_t mode, uint8_t enable)
{
    uint8_t reg_val;
 ...
 */
uint8_t enableLightSensor_apds(uint8_t interrupts)
{
 ...
 */
uint8_t disableLightSensor_apds()
{
    if( !setAmbientLightIntEnable(0) ) {
        return false;
    }
 ...
 * @return True if sensor enabled correctly. False on error.
 */
uint8_t enableProximitySensor_apds(uint8_t interrupts)
{
 ...
 * @return True if sensor disabled correctly. False on error.
 */
uint8_t disableProximitySensor_apds()
{
	if( !setProximityIntEnable(0) ) {
		return false;
	}
 ...
 */
uint8_t enableGestureSensor_apds(uint8_t interrupts)
{
 ...
 */
uint8_t disableGestureSensor_apds()
{
    resetGestureParameters();
    if( !setGestureIntEnable(0) ) {
        return false;
 ...
 */
uint8_t isGestureAvailable_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t readAmbientLight_apds(uint16_t *val)
{
    uint8_t val_byte;
    val = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t readRedLight_apds(uint16_t *val)
{
    uint8_t val_byte;
    val = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t readGreenLight_apds(uint16_t *val)
{
    uint8_t val_byte;
    val = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t readBlueLight_apds(uint16_t *val)
{
    uint8_t val_byte;
    val = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t readProximity_apds(uint8_t *val)
{
    val = 0;
 ...
 */
void resetGestureParameters_apds()
{
    gesture_data_.index = 0;
    gesture_data_.total_gestures = 0;
 ...
 */
uint8_t processGestureData_apds()
{
    uint8_t u_first = 0;
    uint8_t d_first = 0;
    uint8_t l_first = 0;
 ...
 */
uint8_t getProxIntLowThresh_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setProxIntLowThresh_apds(uint8_t threshold)
{
 ...
 */
uint8_t getProxIntHighThresh_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setProxIntHighThresh_apds(uint8_t threshold)
{
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setLEDDrive_apds(uint8_t drive)
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setProximityGain_apds(uint8_t drive)
{
    uint8_t val;
 ...
 */
uint8_t getAmbientLightGain_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setAmbientLightGain_apds(uint8_t drive)
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setLEDBoost_apds(uint8_t boost)
{
    uint8_t val;
 ...
 */
uint8_t getProxGainCompEnable_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
 uint8_t setProxGainCompEnable_apds(uint8_t enable)
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setProxPhotoMask_apds(uint8_t mask)
{
    uint8_t val;
 ...
 */
uint8_t getGestureEnterThresh_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setGestureEnterThresh_apds(uint8_t threshold)
{
 ...
 */
uint8_t getGestureExitThresh_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setGestureExitThresh_apds(uint8_t threshold)
{
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setGestureGain_apds(uint8_t gain)
{
    uint8_t val;
 ...
 */
uint8_t getGestureLEDDrive_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setGestureLEDDrive_apds(uint8_t drive)
{
    uint8_t val;
 ...
 */
uint8_t getGestureWaitTime_apds()
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setGestureWaitTime_apds(uint8_t time)
{
    uint8_t val;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t getLightIntLowThreshold_apds(uint16_t *threshold)
{
    uint8_t val_byte;
    threshold = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setLightIntLowThreshold_apds(uint16_t threshold)
{
    uint8_t val_low;
    uint8_t val_high;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t getLightIntHighThreshold_apds(uint16_t *threshold)
{
    uint8_t val_byte;
    threshold = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setLightIntHighThreshold_apds(uint16_t threshold)
{
    uint8_t val_low;
    uint8_t val_high;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t getProximityIntLowThreshold_apds(uint8_t *threshold)
{
    threshold = 0;
 ...
 * @return True if operation successful. False otherwise.
 */
uint8_t setProximityIntLowThreshold_apds(uint8_t threshold)
{
...
{
    //void i2cSend(APDS9960_I2C_ADDR, BYTE sub, BYTE length, BYTE *data);
	i2cstart();
                                        ...
                                        unsigned int len)
{
	...
	//void i2cSend(APDS9960_I2C_ADDR, reg, len, *val);
   // Wire.beginTransmission(APDS9960_I2C_ADDR);
  //  Wire.write(reg);
   // for(i = 0; i < len; i++) {
