...
#ifndef SparkFun9960_H
#define SparkFun9960_H
...
uint8_t enableLightSensor(uint8_t interrupts);	// false was sent
uint8_t disableLightSensor();
uint8_t enableProximitySensor(uint8_t interrupts);// false was sent
uint8_t disableProximitySensor();
uint8_t enableGestureSensor(uint8_t interrupts);// true was sent
